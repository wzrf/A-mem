...
ANALYZE_CONTENT_PROMPT_QUERY = """Now find the KEYWORDS、CONTEXT and TAGS for the content."""
...
EVOLUTION_DECISION_PROMPT_QUERY = """
Based on the relationships between the new memory and its neighbors, decide:
- NO_EVOLUTION: The memory stands alone, no changes needed.
- STRENGTHEN: The new memory should be linked to some neighbors and its tags updated.
- UPDATE_NEIGHBOR: The neighbors' context/tags should be updated based on new understanding.
...
STRENGTHEN_DETAILS_PROMPT_QUERY = """Which neighbor indices should the new memory connect to? What tags best describe this memory?
...
FOCUSED_KEYWORDS_PROMPT_PREFIX = """List exactly 5 keywords that capture the main concepts of the following text. Output only the keywords, comma-separated, nothing else.
